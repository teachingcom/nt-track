...
export const TRACK_TOP_SCALE = 0.20;
export const TRACK_BOTTOM_SCALE = 0.025;
export const TRACK_SHOULDER_SCALE = 0.06;
export const TRACK_CAR_SIZE_RELATIVE_TO_LANE = 0.88;
export const TRACK_CAR_LANE_CENTER_OFFSET = 0.03;
export const TRACK_STARTING_LINE_POSITION = 0.3;
