...
export const SHOULDER_SCALE = 0.06;
export const CAR_SIZE_RELATIVE_TO_LANE = 0.88;
export const LANE_COUNT = 5;
export const CAR_LANE_CENTER_OFFSET = 0.03;
export const NAMECARD_SCALE = 0.7;
...
export const LANE_CENTER = LANE_START + (LANE_HEIGHT / 2) - (CAR_HEIGHT * CAR_LANE_CENTER_OFFSET);
