...
export default class WampusIntroAnimation extends Animation {
	...
	async init() {
		...
		// save references
		const intro = await animator.create('extras/wampus_intro');
		if (!intro) throw new Error('Missing Wampus Intro animation');
